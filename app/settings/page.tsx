...
export default function SettingsPage(){
  ...
  const configLabel=cloudStatus==="unconfigured"?"站点配置不可用":cloudStatus==="loading"?"正在检查":cloudStatus==="connected"?"连接有效":cloudStatus==="error"?"连接异常":"等待登录";
