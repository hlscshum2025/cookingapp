...
export function AppShell({children}:{children:React.ReactNode}) {
  ...
  return <div className="app-shell">
    <div className="pwa-drag-strip" aria-hidden="true"/>
